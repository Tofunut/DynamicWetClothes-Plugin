...
class SWetClothingAssetEditorPanel : public SCompoundWidget
{
  ...
  private:
    ...
    const FWetClothingAssetWetPartEntry* FindWetPartEntryForUVIsland(int32 UVIslandID) const;
    const FWetClothingAssetWetPartEntry* FindEffectiveWetPartEntryForUVIsland(int32 UVIslandID) const;
    ...
    FReply                                         HandleBuildWetSetupClicked();
    FReply                                         HandleSaveAndBuildClicked();
