...
TSharedPtr<FSlateStyleSet> FDynamicWetClothesEditorStyle::StyleSet;
...
void FDynamicWetClothesEditorStyle::Initialize()
{
    if (StyleSet.IsValid())
    {
        return;
    ...
    SetSvgBrush(*StyleSet, TEXT("DynamicWetClothesEditor.UVTool.Select"), TEXT("EditorIcons/SelectClick_20"), Icon20x20);
...
void FDynamicWetClothesEditorStyle::Shutdown()
{
    if (!StyleSet.IsValid())
    {
        return;
...
FName FDynamicWetClothesEditorStyle::GetStyleSetName()
{
    static const FName StyleSetName(TEXT("DynamicWetClothesEditorStyle"));
    return StyleSetName;
}

const ISlateStyle& FDynamicWetClothesEditorStyle::Get()
{
    if (!StyleSet.IsValid())
    {
        Initialize();
...
const FSlateBrush* FDynamicWetClothesEditorStyle::GetBrush(const FName BrushName)
{
