...
namespace WetClothingSkeletalMeshCacheBuilderInternal
{
    ...
    static bool BuildPrimaryVertexCache(
        ...
        FWetClothingBonePrimaryVertexCache& OutCache,
    ...
    static void ResolveIncludeRules(
        ...
        TArray<FWetClothingResolvedBoneIncludeRule>& OutResolvedIncludeRules)
    {
        ...
        for (const FWetClothingBoneIncludeRule& IncludeRule : IncludeRules)
        {
            ...
            FWetClothingResolvedBoneIncludeRule ResolvedRule;
...
bool FWetClothingSkeletalMeshCacheBuilder::Build(
    const USkeletalMesh*                       SkeletalMesh,
    int32                                      LODIndex,
    const TArray<FWetClothingBoneIncludeRule>& IncludeRules,
    ...
    FString*                                   OutErrorMessage)
{
    ...
    OutCache = FWetClothingSkeletalMeshOptimizationCache();
