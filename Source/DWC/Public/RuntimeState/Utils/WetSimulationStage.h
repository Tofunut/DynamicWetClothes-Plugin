...
/*
Arguments required to execute WetSimulationStage.

This is currently an internal synchronous argument bundle used by DynamicWetClothesComponent when updating
simulation state. CPU simulation updates absorbed-water spreading and drying only; Surface Water is handled
by the GPU backend.
*/
