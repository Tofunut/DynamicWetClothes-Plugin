...
class SWetWrinkleViewport : public SEditorViewport, public FGCObject
{
  ...
  private:
    ...
    FWetWrinkleAccumulatedPreviewState* FindOrAddAccumulatedPreviewState(UTexture* SourceTexture, int32 UVChannelIndex);
    UTexture2D* ResolveAccumulatedPreviewTexture(UTexture* SourceTexture, int32 UVChannelIndex);
