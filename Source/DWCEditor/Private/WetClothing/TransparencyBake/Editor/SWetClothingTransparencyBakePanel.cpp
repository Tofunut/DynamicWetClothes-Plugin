...
#include "WetClothing/TransparencyBake/FinalBake/DWCTransparencyEditedMapBaker.h"
...
{
    return SNew(SVerticalBox)
        + SVerticalBox::Slot().AutoHeight().Padding(0,0,0,6)[FWetClothingEditorCommonWidgets::BuildSectionHeader(LOCTEXT("TransparencyLayers", "Transparency Target Parts"))]
...
{
    const FWetClothingTransparencyLayerData* Layer = GetSelectedLayer();
    TSharedRef<SVerticalBox> Box = SNew(SVerticalBox) + SVerticalBox::Slot().AutoHeight().Padding(0,0,0,6)[FWetClothingEditorCommonWidgets::BuildSectionHeader(LOCTEXT("TargetSurface", "Target Surface"))];
...
{
    const FWetClothingTransparencyLayerData* Layer = GetSelectedLayer();
    TSharedRef<SVerticalBox> Box = SNew(SVerticalBox) + SVerticalBox::Slot().AutoHeight().Padding(0,0,0,6)[FWetClothingEditorCommonWidgets::BuildSectionHeader(LOCTEXT("InnerSource", "Inner Source Parts"))];
...
{
    const FWetClothingTransparencyLayerData* Layer = GetSelectedLayer();
    TSharedRef<SVerticalBox> Box = SNew(SVerticalBox) + SVerticalBox::Slot().AutoHeight().Padding(0,0,0,6)[FWetClothingEditorCommonWidgets::BuildSectionHeader(LOCTEXT("RaySettings", "Ray Settings"))];
...
{
    const UWetClothingAsset* Asset = WetClothingAsset.Get();
    TSharedRef<SVerticalBox> Box = SNew(SVerticalBox) + SVerticalBox::Slot().AutoHeight().Padding(0,0,0,6)[FWetClothingEditorCommonWidgets::BuildSectionHeader(LOCTEXT("BakeSettings", "Bake Settings"))];
...
TSharedRef<SWidget> SWetClothingTransparencyBakePanel::BuildTransparencyBrushSection()
{
    TSharedRef<SVerticalBox> Box = SNew(SVerticalBox)
        ...
        [FWetClothingEditorCommonWidgets::BuildSectionHeader(LOCTEXT("TransparencyBrush", "Transparency Brush"))];
...
{
    const FWetClothingTransparencyLayerData* Layer = GetSelectedLayer();
    return SNew(SVerticalBox) + SVerticalBox::Slot().AutoHeight().Padding(0,0,0,6)[FWetClothingEditorCommonWidgets::BuildSectionHeader(LOCTEXT("GeneratedOutputs", "Generated Output"))]
...
{
    return SNew(SVerticalBox) + SVerticalBox::Slot().AutoHeight().Padding(0,0,0,6)[FWetClothingEditorCommonWidgets::BuildSectionHeader(LOCTEXT("Actions", "Actions"))]
