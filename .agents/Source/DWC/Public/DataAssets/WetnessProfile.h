...
struct DWC_API FSurfaceWaterProfileParameters
{
    ...
    /** Blends the independently selected Secondary Droplet contact toward a random point in the same UV triangle. */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Surface Water|Droplet2", meta = (ClampMin = "0.0", ClampMax = "1.0", DisplayName = "Spawn Position Variation"))
