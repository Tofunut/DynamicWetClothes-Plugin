    ...
    FString& OutErrorMessage)
{
    ...
    for (const int32 LODIndex : LODIndices)
    {
        ...
        Group.UVChannelIndex = FMath::Max(0, WetClothingAsset->WrinkleData.WrinkleUVChannelIndex);
    ...
    FString& OutErrorMessage)
{
    ...
    {
        OutErrorMessage = TEXT("Normal map baking is disabled.");
        return false;
    }
    ...
    UTexture2D* NormalTexture = CreateOrUpdateTextureAsset(
        WetClothingAsset,
