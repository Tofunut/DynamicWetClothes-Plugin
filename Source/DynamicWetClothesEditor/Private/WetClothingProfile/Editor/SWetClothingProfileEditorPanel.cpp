...
#include "WetClothingProfile/Viewport/WetClothingProfileViewport.h"
...
#define LOCTEXT_NAMESPACE "WetClothingProfileEditorPanel"
...
namespace
{
	...
	TArray<FWetClothingProfileUVTriangle> BuildMaterialSlotPreviewTriangles(const USkeletalMesh* SkeletalMesh, int32 MaterialSlotIndex)
	{
		TArray<FWetClothingProfileUVTriangle> PreviewTriangles;

		if (SkeletalMesh == nullptr || FWetClothingProfileMeshAnalyzer::GetNumUVChannels(SkeletalMesh, 0) <= 0)
		{
			return PreviewTriangles;
		}

		TArray<FWetClothingProfileUVIsland> BuiltIslands;
		if (!FWetClothingProfileMeshAnalyzer::BuildMaterialSlotUVIslands(SkeletalMesh, 0, 0, MaterialSlotIndex, BuiltIslands, nullptr))
		{
			return PreviewTriangles;
		}

		for (const FWetClothingProfileUVIsland& Island : BuiltIslands)
		{
	...
	public:
		SLATE_BEGIN_ARGS(SWetClothingMaterialSlotPreview) {}
			SLATE_ARGUMENT(TArray<FWetClothingProfileUVTriangle>, Triangles)
			...
			bool bParentEnabled) const override
		{
			...
			for (const FWetClothingProfileUVTriangle& Triangle : Triangles)
			{
	...
	private:
		TArray<FWetClothingProfileUVTriangle> Triangles;
...
bool TryReadTextureSourceData(UTexture2D* Texture, FWetClothingTextureReadback& OutTextureData, FString& OutErrorMessage)
{
	...
	bool TryComputeIslandAverageColor(
		const FWetClothingProfileUVIsland& Island,
...
void SWetClothingProfileEditorPanel::Construct(const FArguments& InArgs)
{
	...
	auto AddSelectionToolItem = [this](EWetClothingProfileUVSelectionTool Tool, const FText& Label, const FText& Tooltip, const FName IconBrushName)
	{
	...
	FUVSelectionToolItemPtr SelectToolItem = AddSelectionToolItem(
		EWetClothingProfileUVSelectionTool::Select,
	...
	AddSelectionToolItem(
		EWetClothingProfileUVSelectionTool::BoxSelect,
	...
	AddSelectionToolItem(
		EWetClothingProfileUVSelectionTool::EllipseSelect,
	...
	AddSelectionToolItem(
		EWetClothingProfileUVSelectionTool::LassoSelect,
	...
	CurrentUVSelectionTool = EWetClothingProfileUVSelectionTool::Select;
	UVDisplayModeItems.Reset();
	UVDisplayModeItems.Add(MakeShared<EWetClothingProfileUVDisplayMode>(EWetClothingProfileUVDisplayMode::Normal));
	UVDisplayModeItems.Add(MakeShared<EWetClothingProfileUVDisplayMode>(EWetClothingProfileUVDisplayMode::OutlineOnly));
	SelectedUVDisplayModeItem = UVDisplayModeItems[0];
	CurrentUVDisplayMode = EWetClothingProfileUVDisplayMode::Normal;

	auto BuildSelectionToolButton = [this](FUVSelectionToolItemPtr ToolItem)
	{
		return SNew(SButton)
			.ButtonColorAndOpacity(this, &SWetClothingProfileEditorPanel::GetUVSelectionToolButtonColor, ToolItem)
			.ContentPadding(FMargin(2.0f))
			.HAlign(HAlign_Center)
			.VAlign(VAlign_Center)
			.OnClicked(this, &SWetClothingProfileEditorPanel::HandleUVSelectionToolButtonClicked, ToolItem)
			...
			[
				...
				[
					SNew(SImage)
					.Image(this, &SWetClothingProfileEditorPanel::GetUVSelectionToolBrush, ToolItem)
					.ColorAndOpacity(this, &SWetClothingProfileEditorPanel::GetUVSelectionToolIconColor, ToolItem)
				]
			];
	};
	...
	[
			...
			[
				...
				[
					...
					[
						...
						.OnClicked(this, &SWetClothingProfileEditorPanel::HandleSaveAssetClicked)
					]
				]
				...
				[
					...
					.OnGenerateWidget(this, &SWetClothingProfileEditorPanel::GenerateUVChannelComboItem)
					.OnSelectionChanged(this, &SWetClothingProfileEditorPanel::HandleUVChannelSelectionChanged)
					[
						SNew(STextBlock)
						.Text(this, &SWetClothingProfileEditorPanel::GetSelectedUVChannelText)
					]
				]
				...
				[
					...
					[
						SNew(STextBlock)
						.Text(this, &SWetClothingProfileEditorPanel::GetMaterialSlotCountText)
					]
				]
				...
				[
					...
					[
						...
						.IsEnabled(this, &SWetClothingProfileEditorPanel::IsAutoPartitionEnabled)
						.OnClicked(this, &SWetClothingProfileEditorPanel::HandleAutoPartitionClicked)
					]
					...
					[
						...
						[
							...
							.Delta(0.1f)
							.Value(this, &SWetClothingProfileEditorPanel::GetAutoPartitionTolerance)
							.OnValueChanged(this, &SWetClothingProfileEditorPanel::HandleAutoPartitionToleranceChanged)
						]
					]
				]
				...
				[
					...
					[
						...
						.OnGenerateRow(this, &SWetClothingProfileEditorPanel::GenerateMaterialSlotRow)
						.OnSelectionChanged(this, &SWetClothingProfileEditorPanel::HandleMaterialSlotSelectionChanged)
				...
				[
					...
					[
						SNew(STextBlock)
						.Text(this, &SWetClothingProfileEditorPanel::GetWetPartSectionText)
						.Font(SectionHeadingFont)
					]
					...
					[
						...
						.OnClicked(this, &SWetClothingProfileEditorPanel::HandleAddWetPartClicked)
					]
					...
					[
						...
						.IsEnabled(this, &SWetClothingProfileEditorPanel::IsWetPartRemoveEnabled)
						.OnClicked(this, &SWetClothingProfileEditorPanel::HandleRemoveWetPartClicked)
					]
				]
				...
				[
					SNew(STextBlock)
					.AutoWrapText(true)
					.Text(this, &SWetClothingProfileEditorPanel::GetSelectedWetPartText)
				]
				...
				[
					SNew(STextBlock)
					.AutoWrapText(true)
					.Text(this, &SWetClothingProfileEditorPanel::GetWetnessProfileLibraryStatusText)
				...
				[
					...
					.OnGenerateRow(this, &SWetClothingProfileEditorPanel::GenerateWetPartRow)
					.OnSelectionChanged(this, &SWetClothingProfileEditorPanel::HandleWetPartSelectionChanged)
					.OnMouseButtonDoubleClick(this, &SWetClothingProfileEditorPanel::HandleWetPartItemDoubleClicked)
					.SelectionMode(ESelectionMode::Single)
				]
			]
		]
			...
			[
				...
				[
					...
					[
						SNew(STextBlock)
						.AutoWrapText(true)
						.Text(this, &SWetClothingProfileEditorPanel::GetUVStatusText)
					]
					...
					[
						...
						[
							...
							.OnGenerateWidget(this, &SWetClothingProfileEditorPanel::GenerateUVDisplayModeComboItem)
							.OnSelectionChanged(this, &SWetClothingProfileEditorPanel::HandleUVDisplayModeSelectionChanged)
							[
								SNew(STextBlock)
								.Text(this, &SWetClothingProfileEditorPanel::GetSelectedUVDisplayModeText)
							]
						]
					]
					...
					.FillHeight(1.0f)
					[
						SAssignNew(UVView, SWetClothingProfileUVView)
						.OnIslandSelectionChanged(this, &SWetClothingProfileEditorPanel::HandleUVIslandSelectionChangedFromUVView)
					]
				]
				...
				[
					...
					[
						...
						[
							...
							[
								...
								.OnGenerateWidget(this, &SWetClothingProfileEditorPanel::GenerateAssignWetPartComboItem)
								.OnSelectionChanged(this, &SWetClothingProfileEditorPanel::HandleAssignWetPartSelectionChanged)
								[
									SNew(SHorizontalBox)
									...
									[
										...
										[
											...
											.BorderBackgroundColor(this, &SWetClothingProfileEditorPanel::GetSelectedAssignWetPartColor)
										]
									]
									...
									[
										SNew(STextBlock)
										.Text(this, &SWetClothingProfileEditorPanel::GetSelectedAssignWetPartText)
									]
								]
							]
						]
						...
						[
							...
							.HAlign(HAlign_Center)
							.VAlign(VAlign_Center)
							.OnClicked(this, &SWetClothingProfileEditorPanel::HandleAssignSelectedIslandToWetPartClicked)
							[
								SNew(STextBlock)
								.Text(this, &SWetClothingProfileEditorPanel::GetAssignIslandToWetPartText)
					...
					[
						SNew(STextBlock)
						.Text(this, &SWetClothingProfileEditorPanel::GetUVIslandCountText)
					]
					...
					[
						SNew(STextBlock)
						.AutoWrapText(true)
						.Text(this, &SWetClothingProfileEditorPanel::GetSelectedUVIslandText)
					]
					...
					[
						...
						.OnGenerateRow(this, &SWetClothingProfileEditorPanel::GenerateUVIslandRow)
						.OnSelectionChanged(this, &SWetClothingProfileEditorPanel::HandleUVIslandSelectionChanged)
		...
		[
			...
			[
				...
				[
					...
					[
						...
						[
							...
							.MaxSliderValue(4.0f)
							.Delta(0.05f)
							.Value(this, &SWetClothingProfileEditorPanel::GetSelectionLineThicknessScale)
							.OnValueChanged(this, &SWetClothingProfileEditorPanel::HandleSelectionLineThicknessChanged)
						]
					]
					...
					[
						...
						.OnClicked(this, &SWetClothingProfileEditorPanel::HandleFocusPreviewClicked)
					]
				]
				...
				.FillHeight(1.0f)
				[
					SAssignNew(PreviewViewport, SWetClothingProfileViewport)
					.WetClothingProfile(WetClothingProfile.Get())
					.OnIslandPicked(this, &SWetClothingProfileEditorPanel::HandleUVIslandPickedFromPreview)
				]
			]
		]
	];
...
void SWetClothingProfileEditorPanel::RefreshMaterialSlotItems()
{
	...
	if (const UWetClothingProfile* Profile = WetClothingProfile.Get())
	{
...
void SWetClothingProfileEditorPanel::RefreshMaterialTextures()
{
...
void SWetClothingProfileEditorPanel::RefreshTextureToggleWidgets()
{
	TextureThumbnails.Reset();
	...
	TextureSelectionContainer->SetContent(
		...
		.OnGenerateWidget(this, &SWetClothingProfileEditorPanel::GenerateTextureComboItem)
		.OnSelectionChanged(this, &SWetClothingProfileEditorPanel::HandleTextureSelectionChanged)
...
void SWetClothingProfileEditorPanel::RefreshUVChannels()
{
	...
	if (const UWetClothingProfile* Profile = WetClothingProfile.Get())
	{
		const int32 NumUVChannels = FWetClothingProfileMeshAnalyzer::GetNumUVChannels(Profile->TargetMesh, 0);
...
void SWetClothingProfileEditorPanel::RefreshUVIslandList()
{
	...
	const UWetClothingProfile* Profile = WetClothingProfile.Get();
	...
	else
	{
		TArray<FWetClothingProfileUVIsland> BuiltIslands;
		FString ErrorMessage;
		const bool bBuiltIslands = FWetClothingProfileMeshAnalyzer::BuildMaterialSlotUVIslands(Profile->TargetMesh, 0, *SelectedUVChannelItem, SelectedMaterialSlotIndex, BuiltIslands, &ErrorMessage);
		if (!bBuiltIslands)
		{
		...
		else
		{
			for (const FWetClothingProfileUVIsland& Island : BuiltIslands)
			{
				UVIslandItems.Add(MakeShared<FWetClothingProfileUVIsland>(Island));
			}
...
void SWetClothingProfileEditorPanel::RefreshUVView()
{
	if (!UVView.IsValid())
	{
		return;
...
void SWetClothingProfileEditorPanel::RefreshPreviewIslandHighlight()
{
	if (!PreviewViewport.IsValid())
	{
		return;
...
void SWetClothingProfileEditorPanel::RefreshWetPartList()
{
	...
	if (const UWetClothingProfile* Profile = WetClothingProfile.Get())
	{
		...
		for (const FWetClothingProfileWetPartEntry& Entry : Profile->WetPartEntries)
		{
			if (Entry.MaterialSlotIndex == SelectedMaterialSlotIndex && Entry.UVChannelIndex == UVChannelIndex)
			{
				CurrentWetPartItems.Add(MakeShared<FWetClothingProfileWetPartEntry>(Entry));
			}
		}
	}
...
void SWetClothingProfileEditorPanel::RefreshPreviewWetPartOverlay()
{
	if (PreviewViewport.IsValid())
	{
		PreviewViewport->SetSelectableIslands(UVIslandItems);
...
void SWetClothingProfileEditorPanel::RefreshWetPartWidgets()
{
	WetPartInlineRenameWidgets.Reset();
...
void SWetClothingProfileEditorPanel::RefreshAvailableWetnessProfiles()
{
...
void SWetClothingProfileEditorPanel::EnsureDefaultWetPartForSelectedScope()
{
	...
	const int32 UVChannelIndex = GetSelectedUVChannelIndex();
	for (FWetClothingProfileWetPartEntry& Entry : Profile->WetPartEntries)
	{
	...
	Profile->Modify();
	FWetClothingProfileWetPartEntry NewEntry;
...
int32 SWetClothingProfileEditorPanel::GetSelectedUVChannelIndex() const
{
	return SelectedUVChannelItem.IsValid() ? *SelectedUVChannelItem : 0;
}

int32 SWetClothingProfileEditorPanel::FindNextWetPartForSelectedScope() const
{
...
FWetClothingProfileWetPartEntry* SWetClothingProfileEditorPanel::FindMutableWetPartEntry(int32 WetPartID) const
{
	UWetClothingProfile* Profile = WetClothingProfile.Get();
	if (Profile == nullptr)
	{
...
const FWetClothingProfileWetPartEntry* SWetClothingProfileEditorPanel::FindWetPartEntry(int32 WetPartID) const
{
	return FindMutableWetPartEntry(WetPartID);
}

SWetClothingProfileEditorPanel::FWetPartEntryPtr SWetClothingProfileEditorPanel::FindWetPartItemByID(int32 WetPartID) const
{
	for (const FWetPartEntryPtr& Item : CurrentWetPartItems)
	{
...
const FWetClothingProfileWetPartEntry* SWetClothingProfileEditorPanel::FindWetPartEntryForIsland(int32 IslandID) const
{
	if (const UWetClothingProfile* Profile = WetClothingProfile.Get())
	{
		const int32 UVChannelIndex = GetSelectedUVChannelIndex();
...
const FWetClothingProfileWetPartEntry* SWetClothingProfileEditorPanel::FindEffectiveWetPartEntryForIsland(int32 IslandID) const
{
	if (const FWetClothingProfileWetPartEntry* AssignedEntry = FindWetPartEntryForIsland(IslandID))
	{
...
TSet<int32> SWetClothingProfileEditorPanel::GetIslandIDsForWetPart(int32 WetPartID) const
{
	TSet<int32> Result;
...
int32 SWetClothingProfileEditorPanel::GetEffectiveWetPartForIsland(int32 IslandID) const
{
	if (const FWetClothingProfileWetPartEntry* EffectiveEntry = FindEffectiveWetPartEntryForIsland(IslandID))
	{
...
FLinearColor SWetClothingProfileEditorPanel::GetDefaultWetPartColor(int32 WetPartID) const
{
	if (WetPartID == 0)
	{
...
FString SWetClothingProfileEditorPanel::GetDefaultWetPartName(int32 WetPartID) const
{
	return WetPartID == 0 ? TEXT("Part Default") : FString::Printf(TEXT("Part %d"), WetPartID);
}

FString SWetClothingProfileEditorPanel::GetWetPartDisplayName(const FWetClothingProfileWetPartEntry& Entry) const
{
...
FString SWetClothingProfileEditorPanel::GetAssignedProfileLabel(const FWetClothingProfileWetPartEntry& Entry) const
{
...
TArray<FString> SWetClothingProfileEditorPanel::GetProfileSearchPaths() const
{
	if (const UWetClothingProfile* Profile = WetClothingProfile.Get())
	{
#if WITH_EDITORONLY_DATA
...
TMap<int32, int32> SWetClothingProfileEditorPanel::BuildIslandWetPartIDMap() const
{
...
TMap<int32, FLinearColor> SWetClothingProfileEditorPanel::BuildIslandColorMap() const
{
	...
	for (const FUVIslandItemPtr& IslandItem : UVIslandItems)
	{
		...
		if (const FWetClothingProfileWetPartEntry* Entry = FindEffectiveWetPartEntryForIsland(IslandItem->IslandID))
		{
...
TSharedRef<ITableRow> SWetClothingProfileEditorPanel::GenerateMaterialSlotRow(FMaterialSlotItemPtr Item, const TSharedRef<STableViewBase>& OwnerTable)
{
	...
	TArray<FWetClothingProfileUVTriangle> SlotPreviewTriangles;
	UTexture* SlotPreviewTexture = ResolveBestMaterialTexture(MaterialObject);
	if (Item.IsValid()
		&& Item->SlotIndex == SelectedMaterialSlotIndex
		&& SelectedTextureItem.IsValid()
		&& SelectedTextureItem->Texture.IsValid())
	{
...
void SWetClothingProfileEditorPanel::HandleMaterialSlotSelectionChanged(FMaterialSlotItemPtr Item, ESelectInfo::Type SelectInfo)
{
...
TSharedRef<SWidget> SWetClothingProfileEditorPanel::GenerateTextureComboItem(FTextureItemPtr Item)
{
	return BuildTextureComboContent(Item, 36.0f, false);
}

void SWetClothingProfileEditorPanel::HandleTextureSelectionChanged(FTextureItemPtr Item, ESelectInfo::Type SelectInfo)
{
...
TSharedRef<SWidget> SWetClothingProfileEditorPanel::BuildTextureComboContent(FTextureItemPtr Item, float ThumbnailSize, bool bCompactLayout)
{
	TSharedRef<SWidget> ThumbnailWidget =
		SNew(SBorder)
		.Padding(0.0f)
	...
	return SNew(SHorizontalBox)
		...
		[
			...
			.Text(Item.IsValid()
				...
				: LOCTEXT("InvalidTextureComboItem", "Invalid Texture"))
			.OverflowPolicy(ETextOverflowPolicy::Ellipsis)
		];
}

TSharedRef<SWidget> SWetClothingProfileEditorPanel::GenerateUVChannelComboItem(FUVChannelItemPtr Item)
{
...
void SWetClothingProfileEditorPanel::HandleUVChannelSelectionChanged(FUVChannelItemPtr Item, ESelectInfo::Type SelectInfo)
{
...
TSharedRef<SWidget> SWetClothingProfileEditorPanel::GenerateUVDisplayModeComboItem(FUVDisplayModeItemPtr Item)
{
	const FText Label = (!Item.IsValid() || *Item == EWetClothingProfileUVDisplayMode::Normal)
...
void SWetClothingProfileEditorPanel::HandleUVDisplayModeSelectionChanged(FUVDisplayModeItemPtr Item, ESelectInfo::Type SelectInfo)
{
	if (!Item.IsValid())
	{
		return;
...
TSharedRef<ITableRow> SWetClothingProfileEditorPanel::GenerateUVIslandRow(FUVIslandItemPtr Item, const TSharedRef<STableViewBase>& OwnerTable)
{
	FText RowText = LOCTEXT("InvalidUVIsland", "Invalid UV island");
	FLinearColor SwatchColor(0.06f, 0.06f, 0.06f, 1.0f);
	if (Item.IsValid())
	{
		if (const FWetClothingProfileWetPartEntry* EffectiveEntry = FindEffectiveWetPartEntryForIsland(Item->IslandID))
		{
		...
		[
			...
			[
				...
				[
					SNew(SBorder)
					.BorderImage(FAppStyle::Get().GetBrush(TEXT("WhiteBrush")))
					.BorderBackgroundColor(SwatchColor)
				]
			]
			+ SHorizontalBox::Slot()
			.FillWidth(1.0f)
...
void SWetClothingProfileEditorPanel::HandleUVIslandSelectionChanged(FUVIslandItemPtr Item, ESelectInfo::Type SelectInfo)
{
...
void SWetClothingProfileEditorPanel::HandleUVIslandSelectionChangedFromUVView(const TArray<int32>& IslandIDs, EWetClothingProfileUVSelectionOp SelectionOp)
{
	ApplyIslandSelection(IslandIDs, SelectionOp == EWetClothingProfileUVSelectionOp::Add);
}

void SWetClothingProfileEditorPanel::HandleUVIslandPickedFromPreview(int32 IslandID, bool bAppendSelection)
{
...
void SWetClothingProfileEditorPanel::ApplyIslandSelection(const TArray<int32>& HitIslandIDs, bool bAppendSelection)
{
...
void SWetClothingProfileEditorPanel::SetSelectedIslandIDs(const TSet<int32>& InSelectedIslandIDs, int32 InPrimarySelectedIslandID, bool bSyncListSelection)
{
...
void SWetClothingProfileEditorPanel::SyncUVIslandListSelectionToState()
{
	if (!UVIslandListView.IsValid())
	{
		return;
...
void SWetClothingProfileEditorPanel::ResetIslandSelection()
{
...
TSharedRef<ITableRow> SWetClothingProfileEditorPanel::GenerateWetPartRow(FWetPartEntryPtr Item, const TSharedRef<STableViewBase>& OwnerTable)
{
	...
	TSharedRef<ITableRow> Row = SNew(STableRow<FWetPartEntryPtr>, OwnerTable)
		...
		[
			...
			[
				SNew(SButton)
				.ContentPadding(FMargin(2.0f))
				.OnClicked(this, &SWetClothingProfileEditorPanel::HandleToggleWetPartViewClicked, Item)
				.IsEnabled_Lambda([Item]() { return Item.IsValid() && Item->WetPartID != 0; })
				[
					SNew(SImage)
					.Image(this, &SWetClothingProfileEditorPanel::GetWetPartVisibilityBrush, Item)
				]
			]
			...
			[
				...
				[
					...
					[
						...
						.OnTextCommitted(this, &SWetClothingProfileEditorPanel::HandleWetPartNameCommitted, Item)
					]
				...
				[
					...
					[
						...
						.OnGetMenuContent(this, &SWetClothingProfileEditorPanel::BuildWetnessProfilePickerMenu, Item)
						.ButtonContent()
						[
							SNew(STextBlock)
							.Text(this, &SWetClothingProfileEditorPanel::GetWetnessProfileButtonText, Item)
						]
					]
				]
			]
...
void SWetClothingProfileEditorPanel::HandleWetPartSelectionChanged(FWetPartEntryPtr Item, ESelectInfo::Type SelectInfo)
{
...
void SWetClothingProfileEditorPanel::HandleWetPartItemDoubleClicked(FWetPartEntryPtr Item)
{
	if (!Item.IsValid())
	{
		return;
...
void SWetClothingProfileEditorPanel::HandleWetPartNameCommitted(const FText& InText, ETextCommit::Type CommitType, FWetPartEntryPtr Item)
{
	if (!Item.IsValid())
	{
		return;
	...
	UWetClothingProfile* Profile = WetClothingProfile.Get();
	FWetClothingProfileWetPartEntry* Entry = FindMutableWetPartEntry(Item->WetPartID);
...
FReply SWetClothingProfileEditorPanel::HandleToggleWetPartViewClicked(FWetPartEntryPtr Item)
{
	if (!Item.IsValid() || Item->WetPartID == 0)
	{
...
const FSlateBrush* SWetClothingProfileEditorPanel::GetWetPartVisibilityBrush(FWetPartEntryPtr Item) const
{
...
TSharedRef<SWidget> SWetClothingProfileEditorPanel::BuildWetnessProfilePickerMenu(FWetPartEntryPtr Item)
{
...
void SWetClothingProfileEditorPanel::HandleWetnessProfilePicked(FWetPartEntryPtr Item, FWetnessProfileAssetItemPtr ProfileItem)
{
	if (!Item.IsValid())
	{
		return;
...
FReply SWetClothingProfileEditorPanel::HandleAddProfileSearchPathClicked()
{
	UWetClothingProfile* Profile = WetClothingProfile.Get();
	if (Profile == nullptr)
	{
...
TSharedRef<SWidget> SWetClothingProfileEditorPanel::GenerateAssignWetPartComboItem(FWetPartEntryPtr Item)
{
...
void SWetClothingProfileEditorPanel::HandleAssignWetPartSelectionChanged(FWetPartEntryPtr Item, ESelectInfo::Type SelectInfo)
{
	SelectedAssignWetPartID = Item.IsValid() ? Item->WetPartID : INDEX_NONE;
}

FReply SWetClothingProfileEditorPanel::HandleAddWetPartClicked()
{
	UWetClothingProfile* Profile = WetClothingProfile.Get();
	if (Profile == nullptr || SelectedMaterialSlotIndex == INDEX_NONE || !SelectedUVChannelItem.IsValid())
	{
...
FReply SWetClothingProfileEditorPanel::HandleRemoveWetPartClicked()
{
	UWetClothingProfile* Profile = WetClothingProfile.Get();
	...
	{
		const FWetClothingProfileWetPartEntry& Entry = Profile->WetPartEntries[Index];
...
bool SWetClothingProfileEditorPanel::IsWetPartRemoveEnabled() const
{
	return SelectedWetPartID != INDEX_NONE && SelectedWetPartID != 0;
}

bool SWetClothingProfileEditorPanel::IsAutoPartitionEnabled() const
{
	return WetClothingProfile.IsValid()
		&& SelectedMaterialSlotIndex != INDEX_NONE
		&& SelectedUVChannelItem.IsValid()
		&& UVIslandItems.Num() > 0;
}

bool SWetClothingProfileEditorPanel::HasAutoPartitionDataToReplace() const
{
	if (const UWetClothingProfile* Profile = WetClothingProfile.Get())
	{
		const int32 UVChannelIndex = GetSelectedUVChannelIndex();
		for (const FWetClothingProfileWetPartEntry& Entry : Profile->WetPartEntries)
		{
			if (Entry.MaterialSlotIndex == SelectedMaterialSlotIndex
...
FReply SWetClothingProfileEditorPanel::HandleAutoPartitionClicked()
{
	UWetClothingProfile* Profile = WetClothingProfile.Get();
	...
	{
		const FWetClothingProfileWetPartEntry& Entry = Profile->WetPartEntries[EntryIndex];
		if (Entry.MaterialSlotIndex == SelectedMaterialSlotIndex
			&& Entry.UVChannelIndex == UVChannelIndex
			&& Entry.WetPartID != 0)
		{
	...
	EnsureDefaultWetPartForSelectedScope();
	if (FWetClothingProfileWetPartEntry* DefaultEntry = FindMutableWetPartEntry(0))
	{
...
FReply SWetClothingProfileEditorPanel::HandleAssignSelectedIslandToWetPartClicked()
{
	UWetClothingProfile* Profile = WetClothingProfile.Get();
	...
	if (FWetClothingProfileWetPartEntry* SelectedEntry = FindMutableWetPartEntry(SelectedAssignWetPartID))
	{
		for (int32 IslandID : SelectedUVIslandIDs)
		{
...
FText SWetClothingProfileEditorPanel::GetMaterialSlotCountText() const
{
	return FText::Format(
...
FText SWetClothingProfileEditorPanel::GetSelectedMaterialSlotText() const
{
	if (!MaterialSlotItems.IsValidIndex(SelectedMaterialSlotIndex))
	{
...
FText SWetClothingProfileEditorPanel::GetSelectedUVChannelText() const
{
	if (!SelectedUVChannelItem.IsValid())
	{
...
FText SWetClothingProfileEditorPanel::GetSelectedUVDisplayModeText() const
{
	if (!SelectedUVDisplayModeItem.IsValid() || *SelectedUVDisplayModeItem == EWetClothingProfileUVDisplayMode::Normal)
	{
...
FText SWetClothingProfileEditorPanel::GetSelectedTextureText() const
{
	if (!SelectedTextureItem.IsValid())
	{
...
FText SWetClothingProfileEditorPanel::GetUVIslandCountText() const
{
	return FText::Format(
...
FText SWetClothingProfileEditorPanel::GetSelectedUVIslandText() const
{
...
FText SWetClothingProfileEditorPanel::GetUVStatusText() const
{
	return FText::FromString(UVStatusMessage);
}

FText SWetClothingProfileEditorPanel::GetWetPartSectionText() const
{
	if (SelectedMaterialSlotIndex == INDEX_NONE)
	{
...
FText SWetClothingProfileEditorPanel::GetAssignIslandToWetPartText() const
{
	return LOCTEXT("AssignSelectedIslands", "Assign");
}

FText SWetClothingProfileEditorPanel::GetSelectedAssignWetPartText() const
{
...
FSlateColor SWetClothingProfileEditorPanel::GetSelectedAssignWetPartColor() const
{
	if (const FWetPartEntryPtr Item = FindWetPartItemByID(SelectedAssignWetPartID))
	{
...
FText SWetClothingProfileEditorPanel::GetSelectedWetPartText() const
{
	if (SelectedWetPartID == INDEX_NONE)
	{
	...
	if (const FWetClothingProfileWetPartEntry* Entry = FindWetPartEntry(SelectedWetPartID))
	{
		return FText::Format(
...
FText SWetClothingProfileEditorPanel::GetWetnessProfileLibraryStatusText() const
{
...
FText SWetClothingProfileEditorPanel::GetBlendModeText(FWetPartEntryPtr Item) const
{
	if (!Item.IsValid())
	{
...
FText SWetClothingProfileEditorPanel::GetWetnessProfileButtonText(FWetPartEntryPtr Item) const
{
	return Item.IsValid()
...
FReply SWetClothingProfileEditorPanel::HandleUVSelectionToolButtonClicked(FUVSelectionToolItemPtr Item)
{
	if (Item.IsValid())
	{
...
void SWetClothingProfileEditorPanel::SetCurrentUVSelectionTool(EWetClothingProfileUVSelectionTool InTool)
{
...
const FSlateBrush* SWetClothingProfileEditorPanel::GetUVSelectionToolBrush(FUVSelectionToolItemPtr Item) const
{
...
FSlateColor SWetClothingProfileEditorPanel::GetUVSelectionToolIconColor(FUVSelectionToolItemPtr Item) const
{
...
FSlateColor SWetClothingProfileEditorPanel::GetUVSelectionToolButtonColor(FUVSelectionToolItemPtr Item) const
{
	const bool bIsSelected = Item.IsValid() && Item->Tool == CurrentUVSelectionTool;
	return FSlateColor(bIsSelected
...
float SWetClothingProfileEditorPanel::GetAutoPartitionTolerance() const
{
	return AutoPartitionTolerancePercent;
}

void SWetClothingProfileEditorPanel::HandleAutoPartitionToleranceChanged(float InValue)
{
	AutoPartitionTolerancePercent = FMath::Clamp(InValue, 0.0f, 100.0f);
}

float SWetClothingProfileEditorPanel::GetSelectionLineThicknessScale() const
{
	return PreviewViewport.IsValid() ? PreviewViewport->GetSelectionOverlayThicknessScale() : 1.0f;
}

void SWetClothingProfileEditorPanel::HandleSelectionLineThicknessChanged(float InValue)
{
	if (PreviewViewport.IsValid())
	{
...
FReply SWetClothingProfileEditorPanel::HandleFocusPreviewClicked()
{
	if (PreviewViewport.IsValid())
	{
...
FReply SWetClothingProfileEditorPanel::HandleSaveAssetClicked()
{
	DynamicWetClothesEditorUtils::SaveAsset(WetClothingProfile.Get());
	return FReply::Handled();
}

UTexture* SWetClothingProfileEditorPanel::ResolveSelectedMaterialTexture() const
{
	return SelectedTextureItem.IsValid() ? SelectedTextureItem->Texture.Get() : nullptr;
}

void SWetClothingProfileEditorPanel::SaveSelectedTexture()
{
	UWetClothingProfile* Profile = WetClothingProfile.Get();
	...
	for (FWetClothingProfileTextureSelection& Selection : Profile->TextureSelections)
	{
	...
	FWetClothingProfileTextureSelection NewSelection;
