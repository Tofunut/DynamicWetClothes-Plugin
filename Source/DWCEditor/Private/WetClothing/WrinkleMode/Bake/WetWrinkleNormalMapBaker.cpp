    ...
    FString& OutErrorMessage)
{
    ...
    const int32 WrinkleUVChannelIndex = WetClothingAsset->WrinkleData.WrinkleUVChannelIndex;
    if (WrinkleUVChannelIndex == INDEX_NONE)
    {
        OutErrorMessage = TEXT("Generate a wrinkle UV channel before baking wrinkle maps.");
        return false;
    }
