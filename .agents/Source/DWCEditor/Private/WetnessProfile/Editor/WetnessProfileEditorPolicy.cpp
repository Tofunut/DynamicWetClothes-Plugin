...
namespace
{
        ...
        TArray<FString>* OutChanges)
    {
        ...
        bChanged |= ClampRenderableFloat(
            ...
            TEXT("Primary Droplet spawn chance"),
            OutChanges);
        bChanged |= ClampRenderableFloat(
            Surface.DropletRadiusPixels,
            MinRenderableDropletRadiusPixels,
            TEXT("Primary Droplet width"),
            OutChanges);
        bChanged |= ClampRenderableFloat(
            Surface.DropletHeightPixels,
            MinRenderableDropletRadiusPixels,
            TEXT("Primary Droplet height"),
            OutChanges);
        if (Surface.bUseSecondaryDroplets)
        {
            bChanged |= ClampRenderableFloat(
                ...
                MinRenderableDropletSpawnProbability,
                TEXT("Secondary Droplet spawn chance"),
                OutChanges);
            bChanged |= ClampRenderableFloat(
                Surface.DropletFlowRadiusPixels,
                MinRenderableDropletRadiusPixels,
                TEXT("Secondary Droplet width"),
                OutChanges);
            bChanged |= ClampRenderableFloat(
                Surface.DropletFlowHeightPixels,
                MinRenderableDropletRadiusPixels,
                TEXT("Secondary Droplet height"),
                OutChanges);
        }
        ...
        TArray<FString>& OutIssues)
    {
        ...
        {
            OutIssues.Add(FString::Printf(
                TEXT("Primary Droplet spawn chance is %.1f%%; values below %.1f%% can prevent stamps from spawning."),
        ...
        {
            OutIssues.Add(FString::Printf(
                TEXT("Primary Droplet width is %.2f RT pixel(s); values below %.2f cannot produce a stable stamp."),
                Surface.DropletRadiusPixels,
                MinRenderableDropletRadiusPixels));
        }
        ...
        {
            OutIssues.Add(FString::Printf(
                TEXT("Primary Droplet height is %.2f RT pixel(s); values below %.2f cannot produce a stable stamp."),
                Surface.DropletHeightPixels,
                MinRenderableDropletRadiusPixels));
        }
        if (Surface.bUseSecondaryDroplets)
        {
            ...
            {
                OutIssues.Add(FString::Printf(
                    TEXT("Secondary Droplet spawn chance is %.1f%%; values below %.1f%% can prevent stamps from spawning."),
            ...
            {
                OutIssues.Add(FString::Printf(
                    TEXT("Secondary Droplet width is %.2f RT pixel(s); values below %.2f cannot produce a stable stamp."),
                    Surface.DropletFlowRadiusPixels,
                    MinRenderableDropletRadiusPixels));
            }
            ...
            {
                OutIssues.Add(FString::Printf(
                    TEXT("Secondary Droplet height is %.2f RT pixel(s); values below %.2f cannot produce a stable stamp."),
                    Surface.DropletFlowHeightPixels,
                    MinRenderableDropletRadiusPixels));
            }
        }
