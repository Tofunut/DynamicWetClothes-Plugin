...
struct FWCAUVPreviewSourceTriangle
{
    ...
    int32 ImportedVertexIndices[3] = { INDEX_NONE, INDEX_NONE, INDEX_NONE };
    FVector3f LocalNormals[3] = { FVector3f(0.0f, 0.0f, 1.0f), FVector3f(0.0f, 0.0f, 1.0f), FVector3f(0.0f, 0.0f, 1.0f) };
    FVector3f LocalTangents[3] = { FVector3f(1.0f, 0.0f, 0.0f), FVector3f(1.0f, 0.0f, 0.0f), FVector3f(1.0f, 0.0f, 0.0f) };
    FVector3f LocalBitangents[3] = { FVector3f(0.0f, 1.0f, 0.0f), FVector3f(0.0f, 1.0f, 0.0f), FVector3f(0.0f, 1.0f, 0.0f) };
};
