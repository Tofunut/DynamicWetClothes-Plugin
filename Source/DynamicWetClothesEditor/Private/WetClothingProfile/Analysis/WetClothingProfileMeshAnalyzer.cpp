...
namespace WetClothingProfileMeshAnalyzerInternal
{
        ...
        FString*              OutErrorMessage)
    {
        ...
        {
            FWetClothingProfileMeshAnalyzer::SetError(OutErrorMessage, TEXT("No TargetMesh is assigned."));
            return false;
        }
        ...
        {
            FWetClothingProfileMeshAnalyzer::SetError(OutErrorMessage, TEXT("TargetMesh render data is unavailable."));
            return false;
        }

        if (!RenderData->LODRenderData.IsValidIndex(LODIndex))
        {
            FWetClothingProfileMeshAnalyzer::SetError(OutErrorMessage, TEXT("LOD 0 render data is unavailable."));
            return false;
        }

        if (!SkeletalMesh->GetMaterials().IsValidIndex(MaterialSlotIndex))
        {
            FWetClothingProfileMeshAnalyzer::SetError(OutErrorMessage, TEXT("The selected material slot is no longer valid."));
            return false;
        }
        ...
        if (NumUVChannels <= 0)
        {
            FWetClothingProfileMeshAnalyzer::SetError(OutErrorMessage, TEXT("The TargetMesh does not contain any UV channels in LOD 0."));
            return false;
        }

        if (UVChannelIndex < 0 || UVChannelIndex >= NumUVChannels)
        {
            FWetClothingProfileMeshAnalyzer::SetError(OutErrorMessage, TEXT("The selected UV channel is not available on this mesh."));
            return false;
        }
        ...
        {
            FWetClothingProfileMeshAnalyzer::SetError(OutErrorMessage, TEXT("The TargetMesh index buffer is empty."));
            return false;
        }
        ...
        FWetClothingProfileMeshAnalyzer::SetError(OutErrorMessage, TEXT(""));
        return true;
    }
        ...
        TArray<FWetClothingProfileUVIsland>& OutIslands)
    {
        ...
        for (int32 TriangleIndex = 0; TriangleIndex < RawTriangles.Num(); ++TriangleIndex)
        {
            ...
            {
                FWetClothingProfileUVIsland Island;
            ...
            FWetClothingProfileUVIsland& Island = OutIslands[*ExistingIslandIndex];
            const FRawTriangle&          RawTriangle = RawTriangles[TriangleIndex];

            FWetClothingProfileUVTriangle Triangle;
        ...
        OutIslands.Sort(
            [](const FWetClothingProfileUVIsland& A, const FWetClothingProfileUVIsland& B)
            {
    ...
    FString*                             OutErrorMessage)
{
    ...
    TArray<WetClothingProfileMeshAnalyzerInternal::FRawTriangle> RawTriangles;
    const bool                                                   bBuiltTriangles = WetClothingProfileMeshAnalyzerInternal::BuildRawTrianglesFromSkeletalMesh(
        SkeletalMesh,
        LODIndex,
        UVChannelIndex,
        MaterialSlotIndex,
    ...
    WetClothingProfileMeshAnalyzerInternal::BuildIslandsFromRawTriangles(RawTriangles, OutIslands);
