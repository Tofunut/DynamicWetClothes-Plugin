...
class SWetWrinkleEditorPanel : public SCompoundWidget, public FEditorUndoClient
{
  ...
  private:
    ...
    void HandleProjectionAngleSoftnessChanged(float NewValue);
    ...
    EVisibility GetBakedTransparencyWarningVisibility() const;
    FText GetBakedTransparencyWarningText() const;
