...
namespace
{
    ...
    void AddSelectionOverlayBuilderVertex(
        FWetClothingOverlayMeshData& MeshData,
    ...
    FWetClothingOverlayMeshData&               OutMeshData)
{
    ...
    {
        if (!HighlightedIslandIDs.Contains(Island.IslandID))
        {
            continue;
        }
        ...
        {
            const FVector TriangleNormal = WetClothingOverlayNormalUtils::MakeWetPartOverlayNormal(
