...
void SWetClothingTransparencyEditorPanel::RebuildEditorLayout()
{
    ChildSlot
        [SNew(SSplitter)
...
FReply SWetClothingTransparencyEditorPanel::HandleRevealMapPreviewClicked(UObject* Texture, const FText Label, const FText Detail)
{
...
FText SWetClothingTransparencyEditorPanel::GetInnerSourceStatusText() const
{
    return FText::FromString(InnerSourceStatusMessage);
}

FText SWetClothingTransparencyEditorPanel::GetRevealSourceTypeLabel(const EDWCTransparencyRevealSourceType SourceType) const
{
    switch (SourceType)
    {
...
FText SWetClothingTransparencyEditorPanel::GetRevealSourceTypeText() const
{
    return GetRevealSourceTypeLabel(RevealSourceType);
}

TSharedRef<SWidget> SWetClothingTransparencyEditorPanel::GenerateRevealSourceTypeComboItem(TSharedPtr<EDWCTransparencyRevealSourceType> Item) const
{
    return SNew(STextBlock)
        .Text(GetRevealSourceTypeLabel(Item.IsValid() ? *Item : EDWCTransparencyRevealSourceType::MeshRaycast));
}

void SWetClothingTransparencyEditorPanel::HandleRevealSourceTypeChanged(TSharedPtr<EDWCTransparencyRevealSourceType> Item, ESelectInfo::Type SelectInfo)
{
    if (!Item.IsValid())
    {
        return;
...
FString SWetClothingTransparencyEditorPanel::GetManualInnerColorTexturePath() const
{
    return GetPathNameSafe(ManualInnerColorTexture.Get());
}

FString SWetClothingTransparencyEditorPanel::GetManualInnerMaskTexturePath() const
{
    return GetPathNameSafe(ManualInnerMaskTexture.Get());
}

void SWetClothingTransparencyEditorPanel::HandleManualInnerColorTextureChanged(const FAssetData& AssetData)
{
...
void SWetClothingTransparencyEditorPanel::HandleManualInnerMaskTextureChanged(const FAssetData& AssetData)
{
...
ECheckBoxState SWetClothingTransparencyEditorPanel::IsRevealMapTypeChecked(const EDWCTransparencyRevealMapType MapType) const
{
    return SelectedRevealMapType == MapType ? ECheckBoxState::Checked : ECheckBoxState::Unchecked;
}

void SWetClothingTransparencyEditorPanel::HandleRevealMapTypeChanged(const ECheckBoxState NewState, const EDWCTransparencyRevealMapType MapType)
{
...
void SWetClothingTransparencyEditorPanel::UpdateInnerSourceStatus()
{
    const UWetClothingAsset* Asset = WetClothingAsset.Get();
    if (Asset == nullptr)
    {
...
TSharedRef<SWidget> SWetClothingTransparencyEditorPanel::BuildTargetSection()
{
        ...
        + SVerticalBox::Slot()
              ...
              .Padding(0.0f, 0.0f, 0.0f, 10.0f)
                  [SNew(SComboBox<TSharedPtr<EDWCTransparencyRevealSourceType>>)
                       ...
                       .OnGenerateWidget(this, &SWetClothingTransparencyEditorPanel::GenerateRevealSourceTypeComboItem)
                       .OnSelectionChanged(this, &SWetClothingTransparencyEditorPanel::HandleRevealSourceTypeChanged)
                           [SNew(STextBlock)
                                .Text(this, &SWetClothingTransparencyEditorPanel::GetRevealSourceTypeText)]]
...
TSharedRef<SWidget> SWetClothingTransparencyEditorPanel::BuildInnerSourceSection()
{
              ...
              .Padding(0.0f, 0.0f, 0.0f, 8.0f)
                  [SNew(SBorder)
                       ...
                       .BorderImage(FAppStyle::GetBrush(TEXT("Brushes.Recessed")))
                           [SNew(STextBlock)
                                .AutoWrapText(true)
                                .Text(this, &SWetClothingTransparencyEditorPanel::GetInnerSourceStatusText)]];
        ...
        Box->AddSlot()
            ...
            .Padding(0.0f, 0.0f, 0.0f, 10.0f)
                [SNew(SObjectPropertyEntryBox)
                     ...
                     .OnObjectChanged(this, &SWetClothingTransparencyEditorPanel::HandleManualInnerColorTextureChanged)];
        ...
        Box->AddSlot()
            ...
            .Padding(0.0f, 0.0f, 0.0f, 10.0f)
                [SNew(SObjectPropertyEntryBox)
                     ...
                     .OnObjectChanged(this, &SWetClothingTransparencyEditorPanel::HandleManualInnerMaskTextureChanged)];
...
TSharedRef<SWidget> SWetClothingTransparencyEditorPanel::BuildGeneratedOutputsSection()
{
    return SNew(SBorder)
...
TSharedRef<SWidget> SWetClothingTransparencyEditorPanel::BuildBuildSection()
{
    return SNew(SVerticalBox)
        + SVerticalBox::Slot()
              .AutoHeight()
...
TSharedRef<SWidget> SWetClothingTransparencyEditorPanel::BuildPreviewSettingsSection()
{
...
TSharedRef<SWidget> SWetClothingTransparencyEditorPanel::BuildTransparencyPreviewSection()
{
    const FSlateFontInfo SectionHeadingFont = FCoreStyle::GetDefaultFontStyle(TEXT("Bold"), 14);
        ...
        + SHorizontalBox::Slot()
              ...
              .VAlign(VAlign_Center)
                  [SNew(SButton)
                       ...
                       .OnClicked(this, &SWetClothingTransparencyEditorPanel::HandleFocusPreviewClicked)];
...
TSharedRef<SWidget> SWetClothingTransparencyEditorPanel::BuildRevealMapTypeButton(
    ...
    const FText& Label)
{
    return SNew(SCheckBox)
        .Style(FAppStyle::Get(), TEXT("DetailsView.SectionButton"))
        .Type(ESlateCheckBoxType::ToggleButton)
        .IsChecked(this, &SWetClothingTransparencyEditorPanel::IsRevealMapTypeChecked, MapType)
        .OnCheckStateChanged(this, &SWetClothingTransparencyEditorPanel::HandleRevealMapTypeChanged, MapType)
            [SNew(SBox)
...
TSharedRef<SWidget> SWetClothingTransparencyEditorPanel::BuildSelectedRevealMapPreview(
    UObject* Asset,
    const FText& Label,
    const FText& Detail)
{
             ...
             + SVerticalBox::Slot()
                   ...
                   .HAlign(HAlign_Center)
                       [SNew(SButton)
                            ...
                            .OnClicked(this, &SWetClothingTransparencyEditorPanel::HandleRevealMapPreviewClicked, Asset, Label, Detail)
                                [ThumbnailWidget]]
             + SVerticalBox::Slot()
                   .AutoHeight()
