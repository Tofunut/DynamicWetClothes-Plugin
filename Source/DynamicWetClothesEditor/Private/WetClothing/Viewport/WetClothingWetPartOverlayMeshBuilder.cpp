...
#include "WetClothingOverlayNormalUtils.h"
    ...
    FWetClothingOverlayMeshData&               OutMeshData)
{
    ...
    {
        const int32*        WetPartID = IslandToWetPartID.Find(Island.IslandID);
        const FLinearColor* IslandColor = IslandColors.Find(Island.IslandID);
        ...
        {
            const FVector Normal = WetClothingOverlayNormalUtils::MakeWetPartOverlayNormal(
