...
#include "WetClothing/Editor/WetClothingAssetEditor.h"
...
{
    return FDynamicWetClothesEditorStyle::GetBrush(TEXT("ClassThumbnail.WetClothingAsset"));
}

const FSlateBrush* UWetClothingAssetDefinition::GetIconBrush(const FAssetData& InAssetData, const FName InClassName) const
{
    return FDynamicWetClothesEditorStyle::GetBrush(TEXT("ClassIcon.WetClothingAsset"));
}
