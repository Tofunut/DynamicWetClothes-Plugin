                                        ...
                                        + SHorizontalBox::Slot()
                                              .AutoWidth()
                                                  [SNew(SButton)
                                                       ...
                                                       .OnClicked(this, &SWetClothingPartEditorPanel::HandleSaveAssetClicked)]
                                        ...
                                        + SHorizontalBox::Slot()
                                              ...
                                              .Padding(4.0f, 0.0f, 0.0f, 0.0f)
                                                  [SNew(SButton)
                                                       ...
                                                       .OnClicked(this, &SWetClothingPartEditorPanel::HandleBuildWetSetupClicked)]
                                        ...
                                        + SHorizontalBox::Slot()
                                              ...
                                              .Padding(4.0f, 0.0f, 0.0f, 0.0f)
                                                  [SNew(SButton)
                                                       ...
                                                       .OnClicked(this, &SWetClothingPartEditorPanel::HandleSaveAndBuildClicked)]]
                                        ...
                                        + SHorizontalBox::Slot()
                                              .AutoWidth()
                                                  [SNew(SButton)
                                                       ...
                                                       .OnClicked(this, &SWetClothingPartEditorPanel::HandleFocusPreviewClicked)]]
...
TSharedRef<ITableRow> SWetClothingPartEditorPanel::GenerateMaterialSlotRow(FMaterialSlotItemPtr Item, const TSharedRef<STableViewBase>& OwnerTable)
{
    ...
    if (const UWetClothingAsset* WetClothingAssetPtr = WetClothingAsset.Get())
    {
        SlotPreviewTriangles = SWetClothingPartEditorPanelLocal::BuildMaterialSlotPreviewTriangles(WetClothingAssetPtr->TargetMesh, Item.IsValid() ? Item->SlotIndex : INDEX_NONE);
    }
...
FReply SWetClothingPartEditorPanel::HandleBuildWetSetupClicked()
{
    FString               Summary;
...
FReply SWetClothingPartEditorPanel::HandleSaveAndBuildClicked()
{
    FString    Summary;
    bool       bHadWarnings = false;
    const bool bSucceeded = BuildWetSetup(Summary, &bHadWarnings);
