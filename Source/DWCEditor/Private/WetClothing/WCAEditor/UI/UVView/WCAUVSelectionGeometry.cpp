...
bool FWCAUVSelectionGeometry::IsIslandIntersectingPolygon(const FWetClothingAssetUVIsland& Island, const TArray<FVector2D>& PolygonUV)
{
...
bool FWCAUVSelectionGeometry::IsTriangleIntersectingEllipse(
...
bool FWCAUVSelectionGeometry::IsTriangleIntersectingPolygon(
    const FWetClothingAssetUVTriangle& Triangle,
...
bool FWCAUVSelectionGeometry::IsPointInTriangle(
...
bool FWCAUVSelectionGeometry::IsPointInEllipse(
    const FVector2D& Point,
    const FVector2D& EllipseCenter,
    const FVector2D& EllipseRadii)
{
...
bool FWCAUVSelectionGeometry::IsPointInPolygon(const FVector2D& Point, const TArray<FVector2D>& Polygon)
{
    if (Polygon.Num() < 3)
    {
        return false;
...
bool FWCAUVSelectionGeometry::DoesSegmentIntersectEllipse(
...
bool FWCAUVSelectionGeometry::DoLineSegmentsIntersect(
