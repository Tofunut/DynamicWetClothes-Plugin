...
#include "WetClothing/Foundation/TextureAccess/WetClothingTextureAddressUtils.h"
    ...
    FString&                                         OutErrorMessage)
{
    ...
    FWetClothingBakedWetnessProfileMap* BakedWetnessProfileMap = WetClothingAsset->Derived.Inline.BakedWetnessProfileMaps.FindByPredicate(
    ...
    {
        BakedWetnessProfileMap = &WetClothingAsset->Derived.Inline.BakedWetnessProfileMaps.AddDefaulted_GetRef();
    }
