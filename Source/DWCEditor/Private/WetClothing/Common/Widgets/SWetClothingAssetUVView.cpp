...
void SWetClothingAssetUVView::SetSelectedIslands(const TSet<int32>& InUVIslandIDs)
{
...
void SWetClothingAssetUVView::SetHiddenUVIslandIDs(const TSet<int32>& InUVIslandIDs)
{
...
FReply SWetClothingAssetUVView::OnMouseButtonUp(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
    ...
    if (bIsDraggingSelectionShape && MouseEvent.GetEffectingButton() == EKeys::LeftMouseButton)
    {
        ...
        if (UVBounds.bIsValid)
        {
            ...
            BroadcastSelection(HitUVIslandIDs, MouseEvent.IsShiftDown() ? EWetClothingAssetUVSelectionOp::Add : EWetClothingAssetUVSelectionOp::Replace);
        }
...
void SWetClothingAssetUVView::BroadcastSelection(const TArray<int32>& UVIslandIDs, EWetClothingAssetUVSelectionOp SelectionOp) const
{
