...
#include "WetClothing/PartEdit/Partition/WetPartAutoPartitioner.h"
...
void SWetClothingPartEditorPanel::Construct(const FArguments& InArgs)
{
    ...
    CurrentUVSelectionTool = EWetClothingAssetUVSelectionTool::BoxSelect;
...
{
    return FWetClothingEditorCommonWidgets::BuildTextureComboContent(Item, ThumbnailSize, bCompactLayout, MaterialThumbnailPool, &TextureThumbnails);
}
