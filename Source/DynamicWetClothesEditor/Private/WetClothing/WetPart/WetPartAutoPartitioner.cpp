...
namespace
{
    bool WetPartIsPointInsideTriangle(const FVector2D& Point, const FVector2D& A, const FVector2D& B, const FVector2D& C)
    {
    ...
    bool TryComputeIslandAverageColor(
        ...
        FWetPartIslandColorStats&      OutStats)
    {
    ...
    double WetPartComputeColorDistancePercent(const FLinearColor& A, const FLinearColor& B)
    {
    ...
    FString*                                               OutErrorMessage)
{
    ...
    TArray<FWetPartIslandColorStats> IslandStats;
    ...
    for (const TSharedPtr<FWetClothingAssetUVIsland>& IslandItem : Islands)
    {
        ...
        FWetPartIslandColorStats Stats;
    ...
    IslandStats.Sort([](const FWetPartIslandColorStats& A, const FWetPartIslandColorStats& B)
                     {
    ...
    for (const FWetPartIslandColorStats& Stats : IslandStats)
    {
        ...
        {
            const double Distance = WetPartComputeColorDistancePercent(Stats.AverageColor, GetClusterAverageColor(OutClusters[ClusterIndex]));
